...
DECL_CVAR_EXTERN(aimbot_fov);
DECL_CVAR_EXTERN(autoshoot);
DECL_CVAR_EXTERN(esp);
DECL_CVAR_EXTERN(esp_enemy_only);
DECL_CVAR_EXTERN(chams);
DECL_CVAR_EXTERN(chams_enemy_vis_r);
DECL_CVAR_EXTERN(chams_enemy_vis_g);
DECL_CVAR_EXTERN(chams_enemy_vis_b);
DECL_CVAR_EXTERN(chams_enemy_invis_r);
DECL_CVAR_EXTERN(chams_enemy_invis_g);
DECL_CVAR_EXTERN(chams_enemy_invis_b);
DECL_CVAR_EXTERN(chams_friend_vis_r);
DECL_CVAR_EXTERN(chams_friend_vis_g);
DECL_CVAR_EXTERN(chams_friend_vis_b);
DECL_CVAR_EXTERN(chams_friend_invis_r);
DECL_CVAR_EXTERN(chams_friend_invis_g);
DECL_CVAR_EXTERN(chams_friend_invis_b);
DECL_CVAR_EXTERN(chams_hands_r);
DECL_CVAR_EXTERN(chams_hands_g);
DECL_CVAR_EXTERN(chams_hands_b);
